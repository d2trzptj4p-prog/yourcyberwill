...
export function VaultDashboardContent() {
  ...
  return (
    /* We dropped 'absolute'. Instead, we use 'w-screen' and 'relative left-1/2 -translate-x-1/2' 
      ...
      We also swapped 'bg-black' out for 'bg-slate-950' to keep your high-contrast text perfectly readable,
      matching your typography configuration.
    */
    <div className="w-screen relative left-1/2 -translate-x-1/2 bg-slate-950 text-white min-h-screen">
      <div className="mx-auto flex w-full max-w-5xl flex-col gap-8 px-6 py-12">
        ...
        <div className="flex flex-wrap items-center justify-between gap-4 border-b border-slate-800 pb-6">
          <div className="flex items-center gap-3">
            ...
            <LockIcon weight="fill" className="size-7 text-slate-400" />  
          ...
          <Button
            ...
            onClick={lock}
            variant="secondary"
            className="rounded-xl border border-slate-700 bg-slate-900 text-slate-200 hover:bg-slate-800 hover:text-white"
          >
            Lock vault
          </Button>
        </div>
