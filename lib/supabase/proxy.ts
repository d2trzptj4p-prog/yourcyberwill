...
export async function updateSession(request: NextRequest) {
  ...
  const isAuthRoute =
    pathname.startsWith("/login") || pathname.startsWith("/auth") || pathname.startsWith("/blogs") || pathname.startsWith("/sitemap.xml") || pathname.startsWith("/sitemap.xml") ||  pathname.startsWith("/sitemap.xml") || pathname.startsWith("/privacy") || pathname.startsWith("/terms") || pathname.startsWith("/hero.mov")|| pathname.startsWith("/api") || pathname.startsWith("/api/webhooks/polar")|| pathname.startsWith("/blog");
